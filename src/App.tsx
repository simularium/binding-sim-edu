...
import LeftPanel from "./components-temp-folder-name/main-layout/LeftPanel";
import RightPanel from "./components-temp-folder-name/main-layout/RightPanel";
import ReactionDisplay from "./components-temp-folder-name/main-layout/ReactionDisplay";
import ContentPanel from "./components-temp-folder-name/main-layout/ContentPanel";
import content, { moduleNames } from "./content";
import { ReactionType } from "./constants";
import CenterPanel from "./components-temp-folder-name/main-layout/CenterPanel";
import { SimulariumContext } from "./simulation/context";
import NavPanel from "./components-temp-folder-name/main-layout/NavPanel";
import AdminUI from "./components-temp-folder-name/AdminUi";
